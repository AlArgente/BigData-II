...
*/
    ...
    val writer_dt = new PrintWriter(new File("/home/x76654048/results_ROS_180_dt.txt"))
    writer_dt.write(
    ...
    val writer = new PrintWriter(new File("/home/x76654048/results_ROS_180_rf.txt"))
    writer.write(
      "Precision: " + precision + "\n" +
        "Confusion Matrix " + cm + "\n"
    )
    ...
    val writer_pc = new PrintWriter(new File("/home/x76654048/results_ROS_180_pcard.txt"))
    writer_pc.write(
    ...
    val writer_nb = new PrintWriter(new File("/home/x76654048/results_ROS_180_bayes.txt"))
    writer_nb.write(
