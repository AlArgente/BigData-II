...
object runEnsembles {
  ...
  def main(arg: Array[String]) {
    ...
    val test = sc.textFile(pathTest, 10).map(line => converter.parserToLabeledPoint(line)).persist
		...
		val trainROS = ROS(train, 1.4).persist
...
*/
    ...
    val writer_dt = new PrintWriter(new File("/home/x76654048/results_ros_140_dt.txt"))
    writer_dt.write(
    ...
    val writer = new PrintWriter(new File("/home/x76654048/results_ros_140_rf.txt"))
    writer.write(
      "Precision: " + precision + "\n" +
        "Confusion Matrix " + cm + "\n"
    )
    ...
    val writer_pc = new PrintWriter(new File("/home/x76654048/results_ros_140_pcard.txt"))
    writer_pc.write(
    ...
    val writer_nb = new PrintWriter(new File("/home/x76654048/results_ros_140_bayes.txt"))
    writer_nb.write(
