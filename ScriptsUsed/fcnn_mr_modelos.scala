...
*/
    ...
    val writer_dt = new PrintWriter(new File("/home/x76654048/results_fcnn_mr_dt.txt"))
    writer_dt.write(
    ...
    val writer = new PrintWriter(new File("/home/x76654048/results_fcnn_mr_rf.txt"))
    writer.write(
      "Precision: " + precision + "\n" +
        "Confusion Matrix " + cm + "\n"
    )
    ...
    val writer_nb = new PrintWriter(new File("/home/x76654048/results_fcnn_mr_bayes.txt"))
    writer_nb.write(
