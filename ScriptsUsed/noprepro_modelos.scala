...
object runEnsembles {
  ...
  def main(arg: Array[String]) {
    ...
    val writer_dt = new PrintWriter(new File("/home/x76654048/results_dt.txt"))
    writer_dt.write(
    ...
    val writer = new PrintWriter(new File("/home/x76654048/results_rf.txt"))
    writer.write(
      "Precision: " + precision + "\n" +
        "Confusion Matrix " + cm + "\n"
    )
    ...
    val writer_pc = new PrintWriter(new File("/home/x76654048/results_pcard.txt"))
    writer_pc.write(
    ...
    writer_pc.close()
		...
		// Naive Bayes
		val model_nb = NaiveBayes.train(train, lambda = 1.0, modelType = "multinomial")
    ...
    //Write Results
    // Para guardar en el cluster
    // val writer_nb = new PrintWriter(new File("/home/spark/results_ros_bayes.txt"))
    val writer_nb = new PrintWriter(new File("/home/x76654048/results_bayes.txt"))
    writer_nb.write(
